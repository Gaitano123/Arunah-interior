    ...
    return (
        <>
            ...
            <div className='flex flex-wrap justify-evenly items-center mt-[5em]'>
                <div className='box bg-primary w-[25em] p-[2em] mb-[5em] text-center flex flex-col items-center'>
                    <img className='h-[15em] w-[20em] object-cover' src={image3} alt='portfolio-image' />
                    <div>
                        <h3 className='text-[2em]  mt-[1em] p-0 font-heading'>Riverside Apartment</h3>
